		    ...
		    <div class="container  ">
			   <div class="time-box">
					<div class="row time-details text-center">
						...
						<div class="col-md-3">  
						   <p>Total time </p>
						   <span><?php echo sprintf("%02d", $surprise_test[0]['hours']);?>:<?php echo sprintf("%02d", $surprise_test[0]['mins']).":00";?> </span>
						</div>
						<div class="col-md-3">
							<p>Time Elapsed </p>
							<?php 
							$date1 = strtotime($start_date);  $date2 = strtotime($end_date);  $diff = abs($date2 - $date1);  
							...
							?> 
							<span><?php echo sprintf("%02d",$hours);?>:<?php echo sprintf("%02d", $minutes);?>:<?php echo sprintf("%02d", $seconds);?>  </span>
						</div>
						<div class="col-md-3"></div>					
					</div>				
								     ...
								     <ul class=" ques_ans_options clearfix result_page">
                                       <?php  $choices = unserialize($value['choices']);
										...
										<li class="progress_li list_<?php echo $key1;?> <?php echo $correct; ?> <?php echo $chosen; ?>">
									 	...
									 	<label  for="option<?php echo $j;?>" ><span <?php if($value['show_options']==0){?> style="display:none;"<?php }?> ><?php echo $key1;?></span><p >
										  <?php echo $value1;?></p>
										</label>
										</li>
										<?php  $j++; $count_choice++; }  ?>							
