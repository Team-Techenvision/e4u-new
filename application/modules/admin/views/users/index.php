...
<?php 
						...
						?>
                                    ...
                                    <div class="title"><h3 style="display:inline-block"><?php echo $this->lang->line('manageusers');  ?></h3>
                                ...
                                <div class="card-body">
                                		<!-- Flash Message -->
											 ...
											 if($this->session->flashdata('flash_message')){ ?>
												...
												<?php } ?>
												<?php echo form_open(base_url().SITE_ADMIN_URI.'/users/'.$pagestatus.'/'.$pagingstatus.'?sortingfied='.$fieldssort.'&sortype='.$ordersort,'class="search_user"'); ?>
												<div class="form-group">
										            <!-- <div class="col-sm-2">
														<?php //$get_medium[''] = "Select Medium";
														//echo form_dropdown('search_medium',$get_medium,$keyword_medium,'id="search_medium" class="form-control"'); ?>
													</div> -->
													<div class="col-sm-2">
													...
													<!-- <div class="col-sm-2">
														<?php //$get_board[''] = "Select Board";
														//echo form_dropdown('search_board',$get_board,$keyword_board,'id="search_board" class="form-control"'); ?>
										            </div> -->
										            <div class="col-sm-2">
...
<td class="actions text-center"><a href="<?php echo SITE_URL().SITE_ADMIN_URI;?>/users/edit/<?php echo $res['id'];?>" title = "Edit"><span class="icon glyphicon glyphicon-pencil"></span><span class="title">Edit</span></a> / <a href="<?php echo SITE_URL().SITE_ADMIN_URI;?>/users/delete/<?php echo $res['id'];?>/<?php echo $pagestatus.'/'.$pagingstatus.'?sortingfied='.$fieldssort.'&sortype='.$ordersort;?>" title = "Delete" class="delete-con"><span class="icon glyphicon glyphicon-trash"></span><span class="title">Delete</span></a></td>
                                     										</tr>
