				...
				<div class="col-xs-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<?php } ?>
							<?php echo form_open(base_url().SITE_ADMIN_URI.'/banners/'.$pagestatus.'/'.$pagingstatus.'?sortingfied='.$fieldssort.'&sortype='.$ordersort,'class="search_single"'); ?>
										...
										<?php if($total_rows > 0 ) 
										{
											...
											{   
												...
												<tr class="<?php echo $class;?>">
													...
													<?php 
														if($res['image'] != ""){
															$img_src = thumb($this->config->item('banner_img') .$res['image'] ,'75', '75', 'thumb_banner_img',
                                                                                    $maintain_ratio = TRUE);
													...
													<td><?php echo (strlen($res['description'])>30?substr($res['description'],0,30)."...":$res['description']) ;?></td>  
