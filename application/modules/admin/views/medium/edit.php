					...
					<div class="card custom-card">
						<div class="card-header">
							<div class="card-title">
								<div class="title"><?php echo $this->lang->line('editmedium');  ?></div>
							</div>
							<div class="back pull-right">
								<a title="Back" href="<?php echo SITE_URL().SITE_ADMIN_URI;?>/medium">Back</a>
							</div>
						</div>
                    	<div class="card-body">
                    		<!-- Flash Message -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
									<?php echo form_input('name', isset($_POST['name'])?$_POST['name']: (isset($medium['name']) ? $medium['name'] : '') ,'placeholder= "Name" class="form-control" id="name"'); 
