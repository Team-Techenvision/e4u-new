					...
					<div class="card custom-card">
						<div class="card-header">
							<div class="card-title">
								<div class="title"><?php echo $this->lang->line('add_courese_categ');  ?></div>
							</div>
                   		...
                   		<div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
									<?php echo form_input('name',set_value('name'),'placeholder= "Category Name" class="form-control" id="name"'); 
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-4">
									<?php echo form_textarea('description',set_value('description'),'placeholder= "Category Description" class="form-control" id="description"'); 
