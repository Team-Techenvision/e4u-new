					...
					<div class="card custom-card">
						<div class="card-header">
							<div class="card-title">
								<div class="title"><?php echo $this->lang->line('editsubjects');  ?></div>
							</div>
                    	...
                    	<div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
									<?php echo form_input('name', isset($_POST['name'])?$_POST['name']: (isset($subjects['name']) ? $subjects['name'] : '') ,'placeholder= "Name" class="form-control" id="name"'); 
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-4">
									<?php echo form_input('order', isset($_POST['order'])?$_POST['order']: (isset($subjects['sort_order']) ? $subjects['sort_order'] : '') ,'placeholder= "Order" class="form-control" id="order"'); 
