					...
					<div class="card custom-card">
						<div class="card-header">
							<div class="card-title">
								<div class="title"><?php echo $this->lang->line('addfaq');  ?></div>
							</div>
                   		...
                   		<div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
									<?php echo form_input('question',set_value('question'),'placeholder= "Question" class="form-control" id="question"'); 
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
									<?php echo form_textarea('answer',set_value('answer'),'placeholder= "Answer" class="form-control" id="answer"'); 
