                ...
                <div class="card custom-card">
                    <div class="card-header">
                        <div class="card-title">
                            <div class="title"><?php echo $this->lang->line('addsets');  ?></div>
                        </div>
                    ...
                    <div class="card-body">
							...
							<div class="form-group">
								<?php echo form_label('Levels <span class="required">*</span>','search_level',array('class'=>'col-sm-2 control-label')); ?>
								<div class="col-sm-4">
									<?php
...
<?php if(form_error('description['.$i.']')) echo form_label(form_error('description['.$i.']'), 'description['.$i.']', array("id"=>"description-error$i" , "class"=>"error"));
		  if($i>0){ ?>
												<a style="color:red;margin-top:5px" href="javascript:delete_row('<?php echo $i; ?>');" row="<?php echo $i; ?>" class="delete-name pull-right delete<?php echo $i; ?>"><span class="icon glyphicon glyphicon-trash" ></span>Remove </a>
											<?php } ?>                                
                                	</div>
                            	</div>
	</div>
