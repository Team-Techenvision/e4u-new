                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-12">
                                <div class="footer-menu">
                                    <ul>
                                        ...
                                        <a href="<?php echo base_url();?>"><li> About Us </li></a>
                                        <a href="<?php echo base_url().'subscribe';?>"><li> Courses </li></a>
                                        <a href="<?php echo base_url().'faq';?>"><li> FAQ </li></a>
                                        <a href="<?php echo base_url().'contact_us';?>"><li> Contact US </li></a>
                                        <a href="<?php echo base_url();?>"><li> Privacy Policy </li></a>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="footer-copyright">
                                    <p> Copyrights ©2019 E4U. All Rights Reserved </p>
                                </div>
                            </div>
                        </div>
                    </div>
