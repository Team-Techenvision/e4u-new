			...
			setPos = function () {
				...
				if (options.fixed) {
					...
					if (dateInputHasFixedAncestor) {
						...
						if (verticalPosition + dateInputElem.offsetHeight > windowHeight + windowScrollTop-150) {
							verticalPosition = dateInputOffset.top - dateInputElem.offsetHeight -170;
							console.log("2");
						}
					}
